...
class Resolver:
    ...
    def content_ref(self, package: str, kind: str, name: str,
        ...
        # ClassPackage names the package that DEFINES the class, NOT the object's package.
        # Texture/Sound/Music/Mesh are all Engine classes (the editor emits ClassPackage="Engine");
        # using the object's package here made the game fail to resolve the import ("Can't find
        # Texture in file").
        r = self._add(ImportRec(class_package=self.names.index("Engine"),
