...
`FPoly::RemoveColinears` (`dev/docs/unrealed/leveldesign/kb/csg-bsp.md` §5.2), so uedctl
...
# `profile` is a load-time cycle that breaks every uedctl invocation (decisions.md 2026-07-25
...
# stays free of any uedctl dependency but `geometry`).
COLLINEAR_EPS = 1e-4
