...
dev/docs/specs/2026-06-18-uedctl-package-extraction-design.md."""
...
def transitive_closure(dx_path: str, *, search_dirs: list[str]) -> tuple[set[str], set[str]]:
    ...
    the real Deus Ex install (`Tools/uedctl/uned/DeusExAssets/`): closures over 6 real maps land at 6-65
