...
def test_folder_and_label_ride_the_wire_as_carriers(monkeypatch, capsys):
    ...
    assert rc == 0
    assert "uedctl-folder: castle.door" in cap.out
    assert "uedctl-labels:" in cap.out and "hero" in cap.out
