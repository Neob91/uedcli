...
level is the environment variable `$UEDCTL_LEVEL` (a bare name), passed IN to `resolve_level`
...
from uedctl import level_select
from uedctl.level_select import LevelSelectionError
