...
`// uedctl-labels:` interchange carrier.
"""
import pytest

from uedctl import folderlib, labellib
...
# ── the `// uedctl-labels:` interchange carrier ─────────────────────────────────────

def test_format_labels_carrier_is_sorted_comma_joined():
    assert labellib.format_labels_carrier({"b", "a"}) == "    // uedctl-labels: a,b"
