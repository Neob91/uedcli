"""Tests for uedctl.uprops — offline class-property extraction (the actor-prop schema source).
...
from uedctl.tests.conftest import install_system_root  # noqa: E402  (test-only install pointer)
...
def test_corrupt_class_body_raises_schema_error_not_traceback():
    ...
    from uedctl.uprops import Package, SchemaError, class_default_tags
...
def test_an_out_of_range_type_ref_raises_schema_error_not_traceback():
    ...
    from uedctl.uprops import Package, SchemaError, resolve_type_export
