...
WHAT THIS PROVES (be honest):
  uedctl's brush builders are Python REPLICAS of UnrealEd's `BrushBuilders`, which
...
from uedctl.builders import (cube, cylinder, cone, staircase, spiral_staircase,
                             make_brush_actor)
from uedctl.emit import emit_map
from uedctl.model import Brush
