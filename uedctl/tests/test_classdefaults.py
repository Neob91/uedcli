...
from uedctl.classdefaults import ClassDefaults
from uedctl.model import parse_t3d
from uedctl.normalize import canonical_actor_t3d, compare_view, level_order, normalize_level
from uedctl.tests.conftest import install_system_root, read_fixture
...
def test_a_float_property_equal_to_its_default_compares_equal_to_an_omitted_line(defaults):
    """DEFECT 1: this repo's own `uedctl/maps/probe-mv-a5` stores `StayOpenTime=4.0`; the class
