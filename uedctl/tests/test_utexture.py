"""Offline tests for `uedctl.utexture` — the promoted native texture decoder + the
`Package[.Group].Name` ref resolver.

The pixel expectations are FROZEN sha256 digests of the decoded RGB buffers, banked from
the spike-validated decoder (spike `2026-06-27-decontainerize-uedctl/01-native-texture-
...
from uedctl.utexture import (TextureResolver, decode_palette, decode_texture,
