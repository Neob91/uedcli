...
`level-preview-game`), so the same tokens pose either backend. (The old
`TARGET[:MODE][=NAME]` auto-frame grammar and the editor-screenshot backend were deleted at the
`--native` cutover, 2026-07-16.)"""
