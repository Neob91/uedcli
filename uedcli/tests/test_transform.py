...
from uedcli import emit, rotation as R, transform as T
...
def test_scalefield_get_set_unset_round_trip():
    from uedcli.propedit import TYPED_FIELDS, parse_token
...
def test_scalefield_rejects_garbage_whole_value():
    from uedcli.propedit import PropEditError, TYPED_FIELDS, parse_token
    sf = TYPED_FIELDS["mainscale"]
