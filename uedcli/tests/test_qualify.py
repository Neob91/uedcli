...
from uedcli.qualify import parse_loaded_classes, parse_obj_dependencies, qualify_level_textures
...
from uedcli.qualify import qualify_level_classes
...
def test_qualify_live_level_dumps_parses_and_patches(monkeypatch):
    from unittest import mock
    import uedcli.qualify as qualify
    from uedcli.qualify import qualify_live_level
    lvl = Level()
    poly = Polygon(texture="Area51Wall_A")
...
from uedcli.qualify import _read_loaded_classes
