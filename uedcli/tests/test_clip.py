...
from uedcli.clip import clip_brush, classify_clip, axis_plane, _signed_dist
...
def test_clip_cone_on_slanted_face_stays_planar_with_fractions_preserved():
    ...
    from uedcli.builders import cone
...
def test_clip_brush_accepts_decimal_vertex_brushes():
    ...
    from uedcli.builders import cube as build_cube, make_brush_actor
