...
**Spec:** `specs/2026-06-24-uedctl-offline-bsp-engine-design.md` (§6 box). **Decision:** `decisions.md`
...
- **Promote** `_scratch/bspspike/bsp_editorlog.py` → `uedctl/bsp/editorlog.py` (`__init__.py` too):
...
- **Tests** (offline golden, no editor): `uedctl/tests/test_bsp_editorlog.py` —
