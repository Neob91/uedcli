# De-containerize uedctl — eliminate Docker / wine / `.exe` dependencies
...
This is the umbrella record for an investigation into removing uedctl's entire
...
- **Net:** the day-to-day authoring loop can be container-free with Phase A/B (native
  ...
  **The pivotal decision for Andrzej (Q0 in the roadmap spec):** commit to D2 (promote it
  ...
  intermediate. Roadmap + open questions: `../../specs/2026-06-27-uedctl-decontainerization-roadmap-design.md`.
...
| Binary | uedctl uses it for | Native replacement |
|---|---|---|
...
**If uedctl writes the `.dx` natively, the editor disappears — and with it the
