...
Goal: prove uedctl can extract textures WITHOUT `UCC.exe batchexport` (the only
...
spike runs standalone; the production path will reuse uedctl.dxpkg + the export
