...
CONTAINER = "uned-frame-probe-viewsides"
...
printf "VSIDES [%.9g,%.9g,%.9g] [%.9g,%.9g,%.9g] [%.9g,%.9g,%.9g] [%.9g,%.9g,%.9g]\n", *(float*)($fr+0xfc), *(float*)($fr+0x100), *(float*)($fr+0x104), *(float*)($fr+0x108), *(float*)($fr+0x10c), *(float*)($fr+0x110), *(float*)($fr+0x114), *(float*)($fr+0x118), *(float*)($fr+0x11c), *(float*)($fr+0x120), *(float*)($fr+0x124), *(float*)($fr+0x128)
continue
end
