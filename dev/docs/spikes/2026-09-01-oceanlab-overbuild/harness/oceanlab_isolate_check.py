#!/usr/bin/env python3
"""Compare native vs the context-isolated live-editor golden for one or few OceanLab Lab brushes
(pasted into ONE synthetic ADD shell + SUBTRACT room -- see `oceanlab_isolate_golden.py`).
Per-brush surf attribution both sides, by i_actor.

Usage: .venv/bin/python oceanlab_isolate_check.py Brush784 [Brush844 ...]
"""
import os
import sys
