#!/usr/bin/env python3
r"""Live GDB capture: per-brush Pass-1 tree state — counts at EVERY `bspBrushCSG` entry plus a raw
...
Usage: pass1_brush_trace_unatco.py [golden.dx] [outdir]
  -> <outdir>/pass1-brush-trace-unatco.log  +  <outdir>/p1nodes/n%04d.bin (+ nfinal.bin)
"""
import subprocess
import sys
import time
...
def main() -> int:
    ...
    try:
        ...
        log = OUTDIR / "pass1-brush-trace-unatco.log"
