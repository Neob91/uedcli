...
| **[rationale/](rationale/)** | "**Why** is the code this way, and what did we reject?" — engineering decisions an agent made | one doc per module/subsystem, revised in place | agents maintain it freely; every entry carries `Rejected` + `Refs` |
