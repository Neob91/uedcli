...
| [`class arm`](2026-07-26-asset-catalog-class-arm.md) | **findings folded; build FIRST** |
| [`texture arm`](2026-07-26-asset-catalog-texture-arm.md) | **4 open owner decisions** — holds every irreversible call |
| [`audio arms`](2026-07-26-asset-catalog-audio-arm.md) | **BLOCKED** — corpus must be re-measured on the composed path |
...
**[texture arm](2026-07-26-asset-catalog-texture-arm.md)**, because that is where identity is frozen and
...
Read `../rules/tests.md` first. **Per-arm coverage lives in each arm's spec.** This section covers only
the shared engine.
...
3. **`list`/`show` + ObjectProperty-ref validation** — the validation fixes a live bug that silently
   ...
   a prerequisite.
4. Then: **[class arm](2026-07-26-asset-catalog-class-arm.md)** →
   **[texture arm](2026-07-26-asset-catalog-texture-arm.md)** (blocked on 4 owner decisions) →
   **[audio arms](2026-07-26-asset-catalog-audio-arm.md)** (blocked on a re-measurement spike).
