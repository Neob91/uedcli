...
history; read `../decisions.md` 2026-07-25 02:15 UTC and `../unrealed/t3d.md` "Partial struct/array
property values" for what is actually built. Ephemeral per-feature scratch; the durable record is
`../decisions.md`. Supersedes the uncommitted first attempt described in §6.
