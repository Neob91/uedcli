...
3. One subagent reviews the worktree's diff (`git diff base...HEAD`), handed
   [`reviewer-brief.md`](reviewer-brief.md) as its context pack; fix the findings it confirms,
