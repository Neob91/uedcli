...
| **High Shadow Detail** *(no `--add-flag`)* | `0x800000` (`PF_HighShadowDetail`) | Per-surface lightmap resolution — high. Crisp shadows (more lumels, more memory). |
...
- `Mirror` is a surface flag, editor-invisible, and not a portal.
