...
2026-07-17 (spec `spec.md`). New `class list`/`class show` verbs over an offline `classindex.ClassIndex`;
...
unusable (Andrzej). `class show` groups props per declaring class; default truncates ancestor sections to a
