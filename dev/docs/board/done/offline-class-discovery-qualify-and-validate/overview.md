...
2026-07-17 (spec `spec.md`; `rationale/MIGRATION.md`,
...
unusable (Andrzej; tree per `rationale/MIGRATION.md`, 2026-07-18 10:56 UTC). `class show` groups props per declaring class; default truncates ancestor sections to a
