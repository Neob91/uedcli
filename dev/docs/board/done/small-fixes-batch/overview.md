...
`test_class_show_category_rejects_degraded_schema` are deleted (`direction/conventions.md` "No silent
...
described here is gone; see the entry below and `rationale/driver.md` (2026-07-25 11:31 UTC).
