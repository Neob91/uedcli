...
the same config for an unrelated reason, now stated as such. (c) `direction/conventions.md`'s 2026-07-25 10:18
UTC "12 classes / four rejected" enumeration was re-measured against the real composed path
