...
priority = "p2"
kind = "unknown"
summary = "The second name-suffix mover predicate: claim corrected, FIX deferred into the open scoping spec — `inbox.md` re-homed 2026-07-25"
+++

# The second name-suffix mover predicate: claim corrected, FIX deferred into the open scoping spec — `inbox.md` re-homed 2026-07-25
