...
2 naming the brush. Reviewed 2× (fable). Design folded into `architecture.md` (the transform USE
bullet). Covariant UV in preview stays a follow-on (`render-the-full-transform-stack-in-the-textured`).
