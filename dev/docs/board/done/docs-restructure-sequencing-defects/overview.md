...
ephemeral spec; they must land first. Step 6 also writes to the retired ledger, which C1 has by then
replaced. Part A was expected to land a code-cli-conventions rules file citing the direction doc before Part B
