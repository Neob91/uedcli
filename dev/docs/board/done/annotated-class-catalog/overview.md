...
priority = "p3"
kind = "implement"
summary = "Annotated class catalog — FOLDED into the unified asset catalog spec (2026-07-25)"
+++

# Annotated class catalog — FOLDED into the unified asset catalog spec (2026-07-25)

Curated per-class knowledge NOT in the `.u` is now the catalog's class arm
...
derived answer is wrong. Tracked on `board/to-plan/` with the rest of the catalog; this entry stays
