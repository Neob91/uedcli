...
**Tech Stack:** Python 3.12, dataclasses, argparse, pytest via `bin/test`. **Spec:** `spec.md` v3 (symbol-anchored; read it for rationale + evidence). **Decisions:** `decisions.md` 2026-07-24 16:48/16:59/17:19/18:49 UTC.
