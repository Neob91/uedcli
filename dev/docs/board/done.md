...
- **`POLY TEXALIGN` semantics spike — DONE** (2026-07-26, was `p1 [spike]` on `inbox.md`). Measured
  all nine of UnrealEd 2.2's surface-alignment modes live (44 faces × 9 modes, one ephemeral editor,
  `MAP EXPORT` readback) and diffed them against `brush poly align`. Write-up +
  ...
  (new) and the rewritten `POLY` section of `../unrealed/commands.md`; four regressions in
