...
§2.2 (`direction/generators.md`, 2026-07-25 00:14 UTC, D3) defines `--axis x|y|z` on the new `extrude`/`revolve`
...
the `Rotation` zero-omit canonicalization, `rationale/MIGRATION.md` (2026-07-24 21:40 UTC) — so `--axis` now
