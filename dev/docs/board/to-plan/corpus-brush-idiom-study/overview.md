...
priority = "p2"
kind = "implement"
summary = "Corpus brush-idiom study — ground the construction craft in real levels"
+++

# Corpus brush-idiom study — ground the construction craft in real levels
...
done-condition): board item `brush-identify-classify-a-real-brush-s-shape`.
...
`leveldesign/general/brush-shapes.md`/`geometry-and-bsp.md`/`design-craft.md`. Decisions: the
review-refinements addendum. **A few review-driven changes await Andrzej's yes
