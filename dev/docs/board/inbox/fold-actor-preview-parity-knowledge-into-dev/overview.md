...
1. **`architecture.md` "Preview internals"** — record that `actor diagram --faces textured` is now the
...
3. **`unrealed/rendering.md`** "uedcli's offline actor diagram" section still says light-grey background
