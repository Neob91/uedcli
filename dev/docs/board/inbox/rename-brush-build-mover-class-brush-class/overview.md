...
--mover-class <Package.Name>`, direction/generators.md "Generator pattern"), but the general shape is "which brush
...
`docs/usage.md` + `direction/generators.md`'s generator-pattern note. Andrzej flagged.
