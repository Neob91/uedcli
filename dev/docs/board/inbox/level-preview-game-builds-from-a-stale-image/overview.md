...
So on a host provisioned by compose alone, the first `level photo --game` dies at image build:
...
Found running `level photo --game` on `06_HongKong_WanChai_Market.dx`, 2026-08-23.
