...
(those are DONE and make the castle round-trip faithful up to this point — see `direction/materialize.md`
...
binary defaults decode, a third route beating both (a) and (b)); Andrzej decided (direction/packages.md
