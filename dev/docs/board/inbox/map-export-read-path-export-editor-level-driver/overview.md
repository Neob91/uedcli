...
left: materialize goes through `apply.run_materialize`, preview through `preview_native`/
...
patched `dispatch._export_editor_level` to prove `actor preview` never drives the editor was dropped
