...
priority = "p3"
kind = "unknown"
summary = "A fourth confidence marker for AUTHOR-ATTESTED UnrealEd facts?"
+++

# A fourth confidence marker for AUTHOR-ATTESTED UnrealEd facts?
...
`direction/generators.md`), currently filed ✅ with the attestation spelled out inline so
