...
These are the **user-facing** docs — how to *drive* uedctl and how to *design good, buildable
...
- **[leveldesign/](leveldesign/README.md)** — level-design craft for uedctl users: geometry/BSP,
...
uedctl has no monolithic "make a room" command. Small verbs pipe together: a *generator* prints a
