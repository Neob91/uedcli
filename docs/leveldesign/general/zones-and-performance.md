...
Often mis-stated as "portals must be solid". The truth:

- The portal sheet itself is nonsolid. ✅
- The zone-boundary geometry around it must be solid.
...
| Budget            | Limit                                  | Why |
| ----------------- | -------------------------------------- | --- |
| Polys in view     | ~150 (rule of thumb, not a hard limit) | originally ~150; modern hardware handles 400+. The busiest camera view is what matters |
