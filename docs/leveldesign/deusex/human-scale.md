...
| Ceiling            | 128 recommended, ~96–100 minimum — the player cylinder is 95 tall, so it can't stand under 95. (The "83" minimum in UT tutorials is for UT's shorter 78-tall pawn; do not use it for DX.) |
| Corridor width     | ≥48. |
...
All these numbers came from the same offline route, no editor needed. To read any class
