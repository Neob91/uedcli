...
[actor](../actor/README.md) for whole-actor CRUD, [`actor relation`](../actor/relation.md) for exact
geometric facts between a reference face and other actors, [`docs/README.md`](../../README.md) for
`--tree KIND/NAME` (editing a stash/prefab/other level in place), and
