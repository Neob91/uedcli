...
any Deus Ex UCC/SDK) is what decompiles v68 `.u` — now lives in the uedcli doc tree:
...
mount `DeusExAssets`/wire the package `Paths` — uedcli composes each container's asset mounts +
